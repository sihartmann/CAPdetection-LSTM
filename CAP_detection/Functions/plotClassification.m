function [ ] = plotClassification(x, labels, prediction, fs, start, stop, annotations)
    ...
    t1 = datetime(annotations.time{1,1},'InputFormat','HH:mm:ss');
    t2 = t1 + seconds(start);
    ...
    diff_label = diff(labels(start+1:stop));
    ...
    diff_pred = diff(prediction(start+1:stop));
